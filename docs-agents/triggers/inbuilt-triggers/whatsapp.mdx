...
<figure>
  <Thumbnail src="/img/agent-trigger/whatsapp-webhook.png" alt="WhatsApp Trigger Webhook Overview" width='70%'/>
  <figcaption align = "center"><i>WhatsApp Trigger Webhook Overview</i></figcaption>
</figure>
