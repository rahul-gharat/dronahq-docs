...
const SelfChangelog = () => {
  ...
  useEffect(() => {
    fetch('/files/selfhosted-stable.json')
      .then(response => {
        if (!response.ok) {
                ...
                <>
                  <div className={`${styles['header']}`}>
                    ...
                    <div className='d-flex align-center f-wrap'>
                      ...
                      <div className={`${styles['product-tag']} hq-tags border green d-flex align-center pointer justify-center`}>Self-Hosted (Stable)</div>
                    </div>
                  </div>
