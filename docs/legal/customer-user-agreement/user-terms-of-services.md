...
These User Terms are a legally binding contract between you and us. As part of these User Terms, you agree to comply with the most recent version of our [Acceptable Use Policy](/legal/acceptable-use-policy), which is incorporated by reference into these User Terms. If you access or use the Services after being notified of a change to the User Terms or [Acceptable Use Policy](/legal/acceptable-use-policy), you confirm that you have read, understand and agree to be bound by the User Terms and [Acceptable Use Policy](/legal/acceptable-use-policy). "We", "our" and "us" currently refers to the applicable DronaHQ entity in the Contract (defined below).
...
To help ensure a safe and productive work environment, all Authorized Users must comply with our [Acceptable Use Policy](/legal/acceptable-use-policy) and remain vigilant in reporting inappropriate behavior or content to Customer and us.
