...
<iframe 
  className="studio-embed" 
  src="https://poc.dronahq.io/nbTPAjwAVKj6ueLo5JAuhLoSkV3CyaTABrqavG3H7GIAY?type=emd" 
  frameborder="0" 
        loading="lazy" 
...
Additional validation options are provided like Live Validation, Clear After Submission, Read-Only Mode and more.  
