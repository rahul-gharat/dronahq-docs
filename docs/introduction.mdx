...
<div class="containerGridSampleApp">
   <div class=" containerColumnSampleApp columnGrid column-one">
    <div class="containerCol">
      ...
      <div class="containerDescription">A quickstart guide to help you build an app using DronaHQ
      </div>
   </div>
   <div class=" containerColumnSampleApp columnGrid column-two">
      ...
      <div class="containerDescription">Everything you need to know about DronaHQ basics and its core features
      </div>
   </div>  
</div>
