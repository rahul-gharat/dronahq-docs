...
<figure>
  <VideoEmbed host='youtube' videoId='QynFmCsYDio' />
</figure>
...
- [Self-Host DronaHQ](/self-hosted-deployment): Deploy and manage DronaHQ on your local machine or private server instance.
...
<div className="gallery">
    ...
    <div className="card">
      ...
      <VersionedLink to="/datasource-overview">
